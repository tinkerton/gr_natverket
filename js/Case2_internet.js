...
self.nodes = {"content": 
	...
	{  	"ID": "Case2_internet_fraga",
		...
		"answers":[
							...
							{"text":"Jag blir besviken på personer som sprider lögner, det är inte okej.","analysisLog":"2. Svar"},
							{"text":"Det är förnedrande mot de som utsätts och ett allvarligt problem. Människor mår väldigt dåligt av det.","analysisLog":"3. Svar"}
				]
		 ,
		 "animation":"left",
		 "showNextButton":"-1",
